#!/usr/bin/env python3
"""HyperFocus Z0ne - HYPER-SILLs Session End Hook.

Reads the .focus_session_start marker written by sills_session_start.py,
...
def main() -> int:
    now = datetime.now()
    print("\n[SESSION END] HyperFocus Z0ne -- HYPER-SILLs")
    print("-" * 40)
    ...
    if start:
        ...
        print("   Duration: unknown (sills_session_start was not run this session)")
